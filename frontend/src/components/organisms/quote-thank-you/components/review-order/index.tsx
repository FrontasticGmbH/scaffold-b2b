...
const ReviewOrder = ({ onReviewQuoteClick }: Pick<QuoteThankYouProps, 'onReviewQuoteClick'>) => {
  ...
  return (
    <div className="border-b border-neutral-400 pb-6 pt-4 lg:border-none lg:pb-0">
      <span className="text-gray-700 md:text-18 lg:text-20">{translate('thank-you.quotes')}</span>
      <p className="mt-4 text-14 text-gray-700 md:text-16">{translate('thank-you.manage.quotes')}</p>
