  ...
  categoryLinks: [
    {
      ...
      path: '/',
      descendants: [
        { categoryId: ' ct-3-sub-1', name: 'Sub-Category-1', path: '/', descendants: [] },
        { categoryId: ' ct-3-sub-2', name: 'Sub-Category-2', path: '/', descendants: [] },
        { categoryId: ' ct-3-sub-3', name: 'Sub-Category-3', path: '/', descendants: [] },
        { categoryId: ' ct-3-sub-4', name: 'Sub-Category-4', path: '/', descendants: [] },
      ],
    },
    {
      categoryId: 'ct-2',
      name: 'Category-2',
      path: '/',
      descendants: [{ categoryId: 'ct-2-sub-1', name: 'Sub-Category-1', path: '/', descendants: [] }],
    },
    {
      categoryId: 'ct-3',
      name: 'Category-3',
